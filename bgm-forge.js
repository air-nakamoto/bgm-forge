(() => {
  ...
  const MOODS = [
    ...
    {id:'doubt',style:'drift',desc:'辻褄の合わない証言、閉じたはずの扉、視線の気配。まだ何も起きていない調査の時間に、長く敷いておけます。',name:'🔍 疑惑',mode:'dorian',roots:[2,9,7],wave:'sine',autoPattern:'wave',progs:[[0,1,0,6],[0,6,0,1],[1,0,6,0],[0,3,6,0],[6,1,0,6],[0,1,3,6]],drums:'ticks',energy:.42,density:.4},
    ...
    {id:'puzzle',style:'walk',desc:'推理、議論、盤面を睨む時間、調査パート。同じ形を回しながら頭を使う時間に。',name:'🧩 思索',mode:'dorian',roots:[7,0,2],wave:'triangle',progs:[[0,3,0,6],[3,6,3,0],[3,0,6,3],[0,3,6,0],[6,0,3,6],[0,6,0,3]],drums:'light',energy:.6,density:.6},
