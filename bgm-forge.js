(() => {
  ...
  // 並びは画面の6列に合わせて4行ぶん。行ごとにまとまりを持たせてある（2026-09-20）。
  //   1行目 日常・明るい   明るい 街・酒場 カジノ クリア のどか 水辺
  //   2行目 旅・異郷・神秘 民族 和風 神楽 幻想 夜空 荘厳
  //   3行目 情緒・内面     決断 悲哀 回想 鎮魂 思索 疑惑
  //   4行目 緊張・暗黒     暗い 儀式 機械 追跡 緊迫 恐怖
  // 場面を足すときは、どの行に入るかを決めてから。6の倍数を崩すと行の意味が見えなくなる。
  const MOODS = [
