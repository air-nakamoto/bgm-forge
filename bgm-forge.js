(() => {
  ...
  const MOODS = [
    ...
    {id:'ethnic',style:'walk',desc:'異国の街、市場、砂漠、遠い土地への旅。見知らぬ文化に触れる場面や、素性の知れない相手との取引に。民族弦の乾いた撥弦と、増2度を含む東方の音階。持続する低音が下に一本通り、遠い太鼓がときおり鳴ります。',name:'🌍 民族',mode:'phrygianDominant',roots:[0,5,7],wave:'sine',progs:[[0,3,4,0],[0,6,3,0],[0,4,5,3],[3,0,4,0],[0,5,3,4],[5,3,0,4]],drums:'distant',energy:.5,density:.45},
